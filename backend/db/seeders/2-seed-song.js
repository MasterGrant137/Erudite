...
module.exports = {
  up: (queryInterface, Sequelize) => {
    return queryInterface.bulkInsert('Songs', [{userID: 1, artist: "System of a Down", title: "Chop Suey!", producer: "Serj Tankian|Rick Rubin|", body: `[Intro: Serj Tankian]
    ...
    In my self-righteous suicide
    I cry when angels deserve to die
    `, media: `<iframe id="player-CSvFpBOe8eY" src="https://www.youtube.com/embed/CSvFpBOe8eY?controls=2&amp;enablejsapi=1&amp;fs=1&amp;iv_load_policy=3&amp;modestbranding=1&amp;rel=0&amp;playsInline=0&amp;origin=https%3A%2F%2Fgenius.com&amp;start=0" title="Music Video"></iframe>`, visits: 162, coverArt: "https://images.genius.com/6902311b340708c9d085e8f009a670cd.1000x525x1.jpg", createdAt: new Date(), updatedAt: new Date()},{userID: 1, artist: "System of a Down", title: "Toxicity", producer: "Daron Malakian|Rick Rubin|", body: `[Produced by Rick Rubin, Daron Malakian, Serj Tankian]
